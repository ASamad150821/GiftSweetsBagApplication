    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
        <div className="grid gap-10 sm:grid-cols-2 sm:items-center">
            ...
            <div>
                ...
                <h1 className="mt-1 text-4xl font-semibold text-plum">Sweet Surprise Gift Bag</h1>
                ...
                <button type="button" className="mt-8 w-full rounded-full bg-berry px-6 py-3 font-semibold text-white shadow-sm transition hover:bg-berry-dark sm:w-auto" onClick={() => navigate('/order')}>
                Order Now
                </button>
            </div>
        </div>
        ...
        <section className="mt-16 grid gap-6 sm:grid-cols-3">
              <FeatureCard title="Random assortment" body="Every bag is filled with a generous, surprise mix of sweets."></FeatureCard>
              <FeatureCard title="A kind message" body="Add your own words for the label, or let us pick something sweet."></FeatureCard>
              <FeatureCard title="Delivered with care" body="Packed and posted so it arrives ready to bring a smile."></FeatureCard>
        </section>
    </main>
    )
